...
## Project Structure
    ...
    ├── blue_snowflake_dev_113561  # Django project configurations
...
1. Clone this repo and `cd blue_snowflake_dev_113561`
...
2. Clone this repo and `cd blue_snowflake_dev_113561`
